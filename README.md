...
- If new project (not fork):
  - Copy [inspiritsbar.com project files](https://github.com/inspiritsbar/inspiritsbar.com)
...
- `README.md` ⏩ edit baseURL ("inspiritsbar.com") + delete steps bit by bit
- Design
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/inspiritsbar/domains)
  - `Set up a custom domains`
  - `inspiritsbar.com`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.inspiritsbar.com`
  - ...........................................................
...
1. [Servicios inspiritsbar.com](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
